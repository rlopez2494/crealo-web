export default function Header() {
    return (
        <header className="w-full flex justify-center">
            <div className="w-[167px] h-[67px] bg-transparent rounded-[0px_0px_10px_10px] overflow-hidden bg-[linear-gradient(90deg,#005097_0%,#701B8F_100%)] flex items-center justify-center">
