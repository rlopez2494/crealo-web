export default function Header() {
    return (
        <header className="w-full flex justify-center">
            <div className="px-[20px] py-[15px] bg-transparent rounded-[0px_0px_10px_10px] overflow-hidden bg-[linear-gradient(180deg,#005097_0%,#701B8F_100%)] flex items-center justify-center">
